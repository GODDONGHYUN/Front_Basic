...
//  let letVariable = 10;   ->  // ! 블록 레벨 스코프 변수는 중복 선언 할 수 없다고 vscode에서 알려줌
////   let letVariable = 10;

//  호이스팅 : var, function 선언 문을 최상단에 선언 한 것 처럼 동작하는 특성
// * let 키워드로 선언된 변수는 최상단에서 변수의 선언문까지 일시적 사각지대(TDZ : Temporal Dead Zone)에 빠트림

console.log(varHoisting);
var varHoisting = 10;

// ! ReferenceError: Cannot access 'letHoisiting' before initialization
//  console.log(letHoisiting);
//  let letHoisiting = 10;
...
// ! TypeError: Assignment to constant variable. -> 값 재할당 하지 마셈
const ASSIGNMENT = 10;
// // ASSIGNMENT = 11;

// ! SyntaxError: Missing initializer in const declaration -> 초기화 하셈
...
king.name = "이방과"; // ? king.name => 속성으로 접근
