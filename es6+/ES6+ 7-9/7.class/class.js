...
const sampleInstance = new Sample1("퍼블릭 필드", "프라이빗 빌드");

console.log(sampleInstance);
//  console.log(sampleInstance.#privateField) 접근 불가
// console.log(sampleInstance.staticPublicField); // ! undefined
...
Sample3.staticMethod(); // ! 정적 메서드는 클래스로 직접 접근하여 호출해야함
